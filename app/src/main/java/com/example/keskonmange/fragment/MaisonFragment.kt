...
class MaisonFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val touchHelper = ItemTouchHelper(object : ItemTouchHelper.SimpleCallback((ItemTouchHelper.UP or ItemTouchHelper.DOWN), 0) {
            override fun onMove(recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder,
                ...
                val adapter = recyclerView.adapter as MaisonRecyclerViewAdapter
    ...
    private fun getRestos(sort: String): ArrayList<Resto> {
        ...
        val cursor = dbHelper!!.getAllRestoMaison()
    ...
    private fun getSeletedResto(): ArrayList<Resto> {
        ...
        val cursor = dbHelper!!.getSelectedRestoMaison()
    ...
    private fun getResto(cursor: Cursor): Resto {
        ...
        resto.vetto = cursor.getInt(cursor.getColumnIndex(MyDbHelper.COLUMN_VETTO)) > 0
        return resto
    }
    /**
